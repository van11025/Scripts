...
$details = getProductsdetails($invId);
$itemDisplay = buildProductsDetails($details);
$invName = $details['invName'];
include '../view/category-detail.php';
break;

  default:
  $categoryList = buildCategoryList($categories);
  include '\acme\view\prodView.php';
}
?>